...
All notable changes to AleaStrategies are documented here.
...
### Added
- On-chain settlement contract (`contracts/AleaStrategies.sol`) with full edge-alert lifecycle.
...
- 7 signal types mapped to the AleaStrategies signal taxonomy.

## [0.1.0] — 2026-03-10

### Added
- Initial `AleaStrategies.sol` contract with `createMarket`, `fileSignal`, `settleMarket`.
